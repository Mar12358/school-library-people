...
**OOP school library** is the first project in Ruby/Database Module at Microverse.
...
```sh
  cd my-folder
  git clone https://github.com/Mar12358/school-library-people.git
```
...
Feel free to check the [issues page](https://github.com/Mar12358/school-library-people/issues).
